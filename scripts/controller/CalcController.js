class CalcController {
    ...
    calc(){
        ...
        console.log ('lastOperate', this._lastOperator)
    ...
    getLastItem(isOperator = true){
        ...
        if (!lastItem){
            ...
            lastItem = (isOperator) ? this._lastOperator : this._lastOperator;
        }
    ...
    addDot(){
        ...
        let lastOperate = this.getLastOperation()

        if (typeof lastOperate === 'string' && lastOperate.split('').indexOf('.') > -1)return;

        if (this.isOperator(lastOperate) || !lastOperate) {

            this.pushOperation('0.');
            
        } else {
            this. setLastOperation(lastOperate.toString() + '.')
        }
